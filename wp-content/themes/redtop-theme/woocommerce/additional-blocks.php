...
<?php
    ...
    $instr = carbon_get_post_meta(get_the_ID(), 'crb_instruction');
    if (!empty($instr)) {
        echo '<li><a target="_blank" class="inst-link" href="' . $instr . '">Инструкция</a></li>';
    }
...
get_template_part('template-parts/recipes-slider');
